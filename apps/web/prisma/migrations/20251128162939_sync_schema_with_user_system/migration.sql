...
-- AlterTable
ALTER TABLE "banners" ADD COLUMN     "buttonColor" TEXT,
ADD COLUMN     "showButton" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "text" TEXT,
ADD COLUMN     "textColor" TEXT;

-- AlterTable
ALTER TABLE "categories" ADD COLUMN     "endDate" TIMESTAMP(3),
ADD COLUMN     "highlightTextColor" TEXT,
...
ADD COLUMN     "isMedicament" BOOLEAN NOT NULL DEFAULT false,
...
ADD COLUMN     "sku" TEXT,
ADD COLUMN     "usageTips" TEXT,
ADD COLUMN     "weight" DECIMAL(10,3);

-- AlterTable
ALTER TABLE "promotions" ADD COLUMN     "buttonColor" TEXT,
ADD COLUMN     "buttonText" TEXT DEFAULT 'JE FONCE',
...
-- CreateIndex
CREATE INDEX "products_isMedicament_idx" ON "products"("isMedicament");
